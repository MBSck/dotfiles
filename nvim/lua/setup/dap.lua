return {
    init = function ()
        ...
        nnoremap("<leader>di", function() require("dap").step_into() end, { desc = "Step Into" })
        nnoremap("<leader>dw", function() require("dap.ui.widgets").hover() end, { desc = "Widgets" })
        nnoremap("<leader>dr", function() require("dap").repl.open() end, { desc = "Repl" })
        nnoremap("<leader>du", function() require("dapui").toggle({}) end, { desc = "Dap UI" })
        nnoremap("<leader>ds", function() require("osv").launch({ port = 8086 }) end, { desc = "Launch Lua Debugger Server" })
        nnoremap("<leader>dd", function() require("osv").run_this() end, { desc = "Launch Lua Debugger" })
    end,

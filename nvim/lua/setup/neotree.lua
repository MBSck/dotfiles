return {
    setup = function()
        ...
        vim.fn.sign_define("DiagnosticSignError",
            {text = icons.lsp.Error.." ", texthl = "DiagnosticSignError"})
        vim.fn.sign_define("DiagnosticSignWarn",
            {text = icons.lsp.Warn.." ", texthl = "DiagnosticSignWarn"})
        vim.fn.sign_define("DiagnosticSignInfo",
            {text = icons.lsp.Info.." ", texthl = "DiagnosticSignInfo"})
        vim.fn.sign_define("DiagnosticSignHint",
            {text = icons.lsp.Hint.." ", texthl = "DiagnosticSignHint"})
        ...
        require("neo-tree").setup({
            ...
            default_component_configs = {
                ...
                indent = {
                    ...
                    -- indent guides
                    with_markers = true,
                    indent_marker = icons.neotree.indent_marker,
                    last_indent_marker = icons.neotree.last_indent_marker,
                    highlight = "NeoTreeIndentMarker",
                    -- expander config, needed for nesting files
                    with_expanders = nil, -- if nil and file nesting is enabled, will enable expanders
                    expander_collapsed = icons.neotree.expander_collapsed,
                    expander_expanded = icons.neotree.expander_collapsed,

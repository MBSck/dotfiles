...

{
    ...
    -- TODO: Check all functions and retain only the needed ones
    keys = {
        { "<f4>", ":w<CR><cmd>lua _pytest_toggle()<CR>", { silent = true } },
        { "<f5>", ":w <CR><cmd>lua _python_toggle()<CR>", { silent = true } },
        { "<leader><f5>", ":w <CR><cmd>lua _python_package_toggle()<CR>", { silent = true } },
        { "<f6>", ":w <CR><cmd>lua  _rust_cargo_run_toggle()<CR>", { silent = true } },
        { "<f8>", "<cmd>lua _lazygit_toggle()<CR>", { silent = true } },
        { "<f9>", "<cmd>lua _terminal_toggle()<CR>", { silent = true } },
    }
}
